...
#' @param threshold Time difference in seconds between two measures that we consider before marking a point, time less that this amount is considered spurious or false and is not taken into account
